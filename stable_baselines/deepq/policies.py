        ...
        with tf.variable_scope("model", reuse=reuse):
            with tf.variable_scope("action_value"):
                if feature_extraction == "cnn":
                    ...
                    for layer_size in layers:
                        action_out = tf.keras.layers.Dense(unit= layer_size, activation=None)(action_out)
                ...
                action_scores = tf.keras.layers.Dense(unit = self.n_actions, activation=None)(action_out)
            ...
            if self.dueling:
                with tf.variable_scope("state_value"):
                    ...
                    for layer_size in layers:
                        state_out = tf.keras.layers.Dense(unit = layer_size, activation=None)(state_out)
                    ...
                    state_score = tf.keras.layers.Dense(unit = 1, activation=None)(state_out)
